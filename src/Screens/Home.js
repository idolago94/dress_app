...
import {StyleSheet, View, Text, FlatList, Button, TextInput, Dimensions} from 'react-native';
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Dress App</Text>
          <TextInput
              style={{borderRadius: 10, backgroundColor: 'gray', width: Dimensions.get('window').width*0.6, padding: 10}}
          ...
          <FlatList
              ...
              renderItem={({item, i}) => (
                  <Item key={i} data={item} onAddItem={(item) => this.onAddItem(item)} />
              )}
          />
          <View
            style={{
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center'}}>
              <Button
                ...
                disabled={Object.keys(this.props.sets.newSet).find(item => item == 'shirt')}
              />
              <Button
                title={'pants'}
                onPress={() =>
                ...
                disabled={Object.keys(this.props.sets.newSet).find(item => item == 'pants')}
              />
              <Button
                title={'shoes'}
                onPress={() =>
                ...
                disabled={Object.keys(this.props.sets.newSet).find(item => item == 'shoes')}
              />
            </View>
            <Button
              title={'SAVE'}
